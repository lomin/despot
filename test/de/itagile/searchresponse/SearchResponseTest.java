...
import static de.itagile.searchresponse.BracketResponse.bracket_response;
...
import static de.itagile.searchresponse.IsInvalidRequestBasedOnConfiguredMenu.if_invalid_request_based_on_configured_menu;
...
import static de.itagile.searchresponse.IsStepUpPossible.is_step_up_possible;
import static de.itagile.searchresponse.ManualRedirect.manual_redirect;
import static de.itagile.searchresponse.NotFound.not_found;
...
import static de.itagile.searchresponse.RedirectToLastConfiguredLevel.redirect_to_last_configured_level;
    ...
    public void integrationTest() throws Exception {
        ...
        Despot<ISearchParams>.MediaTyped<Map, JsonFormat> categoryResponse =
                despot.
                        ...
                        mediaType(201, MediaTypeTest.HTML_MEDIA_TYPE).
        ...
        despot
                .status(201, MediaTypeTest.HTML_MEDIA_TYPE, new Despot.Recreatable<Viewable>() {
                    @Override
                    public Viewable recreate() {
                        return new Viewable();
                    }
                })
                .status(301, MediaTypeTest.PRODUCT_MEDIA_TYPE, new Despot.Recreatable() {
                    @Override
                    public HashMap recreate() {
                        return new HashMap();
                    }
                });
